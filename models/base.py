...
from .common import Residual, ConvShuffle
...
class Net(nn.Module):
    def __init__(self, n_frames, n_channels, scale_factor, **kwargs):
        ...
        self.out = ConvShuffle(
            16, n_channels, 3, padding=1, scale_factor=scale_factor
        )
...
if __name__ == "__main__":
    ...
    # torch.onnx.export(model, inputs, "onnx/baseline.onnx")
